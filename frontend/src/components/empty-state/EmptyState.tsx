  ...
  return (
    <div className="flex h-full w-full items-center justify-center p-8 text-center animate-fade-in select-none">
      <div className="max-w-xs flex flex-col items-center">
        <div className="relative flex h-16 w-16 items-center justify-center rounded-panel bg-raised border border-accent/10 text-accent shadow-sm">
          <div className="absolute inset-0 rounded-panel bg-accent/5 blur-lg" />
