...
const menuItemBase =
  ...
  'flex h-8 w-full items-center gap-2 whitespace-nowrap rounded-control-sm px-2 text-left text-ui font-normal leading-normal cursor-pointer transition-colors'
