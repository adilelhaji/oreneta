  ...
  return (
    <>
      <button
        ...
        className="flex max-w-full items-center gap-1 self-start rounded-control-sm px-1.5 py-0.5 text-caption text-secondary hover:bg-active hover:text-primary transition-colors cursor-pointer"
      >
